import { $n as toRef$1, Bt as onUnmounted, Gn as reactive, Hn as onScopeDispose, It as onMounted, Jn as shallowReactive, Kn as readonly, Ln as isReactive, Mt as onBeforeUnmount, N as Fragment, Nn as effectScope, Nt as onBeforeUpdate, Pn as getCurrentScope, Qn as toRaw, Rn as isReadonly, St as inject, Vn as markRaw, Vt as onUpdated, W as computed, Wt as provide, Xn as shallowRef, _n as watch, dt as getCurrentInstance, er as toRefs$1, gt as hasInjectionContext, i as TransitionGroup, jn as customRef, jt as onBeforeMount, kt as nextTick, mt as h, qn as ref, rr as unref, rt as defineComponent, tr as toValue$1, vn as watchEffect, zn as isRef } from "./vue.runtime.esm-bundler-BJXEUxZk.js";
...
function useCssVar(prop, target, options = {}) {
	...
	function updateCssVar() {
		...
		if (el && window && key) variable.value = ((_a = window.getComputedStyle(el).getPropertyValue(key)) == null ? void 0 : _a.trim()) || variable.value || initialValue;
	}
...
function useDropZone(target, options = {}) {
	...
	if (isClient) {
		...
		const checkValidity = (items) => {
			const dataTypesValid = checkDataTypes(Array.from(items != null ? items : []).map((item) => item.type));
...
function useFullscreen(target, options = {}) {
	...
	async function exit() {
		...
		if (exitMethod.value) if ((document == null ? void 0 : document[exitMethod.value]) != null) await document[exitMethod.value]();
		else {
			const target2 = targetRef.value;
